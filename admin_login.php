...
<div class="form_div">
	...
	<!-- <form name="login_form" onsubmit="return(valid())" method="POST">
		<p id="frm_tip">ADMINISTRATION LOGIN</p>

		<div><i class="fa fa-envelope"></i><input type="email" name="log_mail" placeholder="Enter Email" id="mail" required></div>
		<i id="mail_err"></i>
		<div><i class="fa fa-lock"></i><input type="password" name="log_pass" placeholder="Enter password" id="pass1" required><i class="fa fa-eye" id="showp"></i><i class="fa fa-eye-slash" id="hidep"></i></div>
		<i id="pass_err"></i>
		<p><button type="submit" name="log_btn">Proceed</button></p>
	</form> -->
...
<form class="form_container" name="login_form" onsubmit="return(valid())" method="POST">
  <div class="title_container">
    ...
    <span class="subtitle">Hey bro Good to have you Back enjoy the experience.</span>
  </div>
  <br>
  <div class="input_container">
    <label class="input_label" for="mail">Email</label>
    ...
    <input placeholder="name@mail.com" title="my gee enter your email mk we cashout"  name="log_mail" id="mail" required type="email" class="input_field">
  </div>
  ...
  <div class="input_container">
    ...
    <input type="password" name="log_pass" placeholder="Enter password" id="pass1" required title="Cashout okpor" class="input_field">
  </div>
  <button name="log_btn" title="Sign In" type="submit" class="sign-in_btn">
    <span>Sign In</span>
  </button>
...
$user_password=clean($_POST['log_pass']);
...
$sel_log="select * from admin_table where email='$mail' && password='$user_password' ";
...
.form_div form div,.login_div form div{
	...
	border-radius: 30px;
	border: 0.5px solid rgb(11, 100, 195);
...
<script type="text/javascript">
	// START OF JAVASCRIPT VALIDATION FORLOGIN FORM
