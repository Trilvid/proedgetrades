<div>
	...
	$user_sel="select * from trading_table where status='active' and account_type='demo'";
...
<!-- CONTAINER HOUSING ALL CONTENTS IN THE DASHBOARD -->
	<div class="main_loader">
		...
		<div>
		<div>
			<h2>All system Active Demo Trades</h2>
...
if(isset($_POST['loss_trade'])){
    ...
    $up_act="update user_table set demo=demo+'$return_tot' where id='$trader_id'";
    ...
    if($up_act_done){
        ...
        if($up_sql_done){
            echo "<script>window.location='active-demo'; </script>";
        }
    }
