<div>
	...
	$user_sel="select * from kyc_table where status='In progress'";
...
<!-- CONTAINER HOUSING ALL CONTENTS IN THE DASHBOARD -->
	<div class="main_loader">
		...
		<div>
		<div>
			<h2>All system Pending KYC</h2>
			<p>Accept or Reject KYC on the system!!</p>
		</div>
		...
		<table width="100%" bgcolor="" class="main_table" cellpadding="10" cellspacing="0" align="center">
			<tr style="background:slateblue;color: wheat;">
				<th>S/N</th><th>Userame</th><th>Email</th><th>Date</th><th>ID type</th><th>ID number</th><th>Expiry Date</th><th>Address</th><th>Post Code</th><th>City</th><th>City</th><th>State</th><th>country</th><th>image</th><th>Status</th><th colspan="2" style="text-align:center;">Action</th>
			</tr>
			...
			<tr>
                ...
                <td><img src="../xmglobalsverify/<?php echo $user['img_name']; ?>" width='100px' height='100px'></td>
				<td><?php echo ucwords($user['status']); ?></td>
                <td><form method="POST" action='admin_action.php'><input type="hidden" name="row_id" value="<?php echo $user['id']; ?>"><input type="hidden" name="verify_id" value="<?php echo $user['verify_id']; ?>">
					<button type="submit" name="accept_btn" style="background:green">
						Accept</form>
				</td>
				<td><form method="POST" action='admin_action.php'>
				<input type="hiddenx" name="del_file" value="../xmglobalsverify/<?php echo $user['img_name']; ?>">
					<input type="hidden" name="row_id" value="<?php echo $user['id']; ?>"><input type="hidden" name="verify_id" value="<?php echo $user['verify_id']; ?>">
					<button type="submit" name="reject_btn" style="background:red">
						Reject</form>
				</td>
			</tr>
