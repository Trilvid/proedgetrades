<div>
	...
	$user_sel="select * from trading_table where status='awaiting' and account_type='spot'";
...
<!-- CONTAINER HOUSING ALL CONTENTS IN THE DASHBOARD -->
	<div class="main_loader">
		...
		<div>
		<div>
			<h2>All system Pending Trades</h2>
...
if(isset($_POST['accept_trade'])){
    ...
    $up_user="update user_table set spot=spot-'$trade_amt' where id='$trader_id'";
    ...
    if($up_user_done){
        ...
        echo "<script>window.location='pending-trades'; </script>";
    }
}
