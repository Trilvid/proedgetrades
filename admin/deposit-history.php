<div>
	...
	$user_sel="select * from deposit_table ";
...
<!-- CONTAINER HOUSING ALL CONTENTS IN THE DASHBOARD -->
	<div class="main_loader">
		...
		<div>
			...
			<p>Below are all deposit on the system!!</p>
		</div>
		...
		<table width="100%" bgcolor="" class="main_table" cellpadding="10" cellspacing="0" align="center">
			<tr style="background:slateblue;color: wheat;">
				<th>S/N</th><th>Username</th><th>Email</th><th>Amount</th><th>Coin</th><th>Deposit_date</th><th>Transaction_ID</th><th>Status</th>
			</tr>
