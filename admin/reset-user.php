...
<!-- CONTAINER HOUSING ALL CONTENTS IN THE DASHBOARD -->
	<div class="main_loader">
		...
		<div>
			...
			<p>Enter user email to reset password!!</p>
		</div>
		<div class="board_cont">
		<form method="POST">
			<input type="email" name="res_em" placeholder="Enter Email"> <br><br>
			<input type="text" name="res_pass" placeholder="Enter new password">
			<p><button type="submit" name="top_up_btn">Reset</button></p>
		</form>
	</div>
</div>
...
$res_em=clean($_POST['res_em']);
$res_pass=clean(hash('sha256', $_POST['res_pass']));

$top_up_sql="update user_table set password='$res_pass' where email='$res_em' ";
