<div>
	...
	$user_sel="select * from withdrawal_table ";
...
<!-- CONTAINER HOUSING ALL CONTENTS IN THE DASHBOARD -->
	<div class="main_loader">
		...
		<div>
			...
			<p>Below are withdrawals on the system!!</p>
		</div>
		...
		<table width="100%" bgcolor="" class="main_table" cellpadding="10" cellspacing="0" align="center">
			<tr style="background:slateblue;color: wheat;">
				<th>S/N</th><th>Username</th><th>Email</th><th>Amount</th><th>Withdrawal date</th><th>Coin</th><th>Wallet_address</th><th>Type</th><th>Status</th>
			</tr>
