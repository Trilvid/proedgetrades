<div>
	...
	$user_sel="select * from investment_table ";
...
<!-- CONTAINER HOUSING ALL CONTENTS IN THE DASHBOARD -->
	<div class="main_loader">
		...
		<div>
		<div>
			<h2>All system Investment</h2>
			<p>Below are all investments on the system!!</p>
		</div>
		...
		<table width="100%" bgcolor="" class="main_table" cellpadding="10" cellspacing="0" align="center">
			<tr style="background:slateblue;color: wheat;">
				<th>S/N</th><th>Username</th><th>Email</th><th>Plan</th><th>Amount</th><th>Total returned</th><th>Investment date</th><th>Status</th>
			</tr>
