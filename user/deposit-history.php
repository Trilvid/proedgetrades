<div>
	...
	$pend_sel="select * from deposit_table where depositor_id='$sess_id' ";
...
<!-- LOADING DIV CONTAINER -->
	...
	<section class="area_txt_cont">
		...
		<section>
			<b style="color:;font-size:18px;font-family: monospace;">Detailed deposit history below</b> <br><br><span id="tip">Check transactions history for detailed overview of your account.</span>
		</section>

		<section class="overviewx">

			<section>
			<table width="100%" class="main_table" cellpadding="7" cellspacing="0" align="center">
					<tr>
						<th>S/N</th><th>Date</th><th>Amount</th><th>Deposit method</th><th>Status</th>
					</tr>
