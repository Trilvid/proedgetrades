<div>
	...
	?>
	<?php
	$pend_sel="select * from investment_table where investor_id='$sess_id' and status!='checking' ";
...
<!-- LOADING DIV CONTAINER -->
	...
	<section class="inner_load_cont">
		...
		<section class="pending_dep_txt">
			<span><b><i class="fa fa-credit-card"></i>Investment History</b></span>
			<span>View all investment history of your account</span>
		</section>

				<section class="pending_sect">
				<table width="100%" bgcolor="" class="main_table" cellpadding="7" cellspacing="0" align="center">
					<tr>
						<th>S/N</th><th>Date</th><th>Amount</th><th>Plan</th><th>Profit Earned</th><th>Total return</th><th>Duration</th><th>Due date</th><th>Status</th>
					</tr>
					...
					<?php while ($pending=$pend_dep->fetch_assoc()){ ?>
						...
						<tr>
							...
							<td><?php echo $pending['profit']; ?></td>
							<td><?php echo $pending['total_return']; ?></td>
							<td><?php echo $pending['duration']; ?></td>
							<td><?php echo $pending['due_date']; ?></td>
		...
		<p id="no_act" style="text-align: center;"><img src="../pics/err.png" width="250px" height="300px"><br>no Investment yet!!</p>
		</section>
