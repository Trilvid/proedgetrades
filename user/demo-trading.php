	...
	<div class="load_cont">
		...
		<div class="chartHolder">
			<div class="chartText">
				...
				<span>
					<p>$<?php echo $row_details['demo']; ?></p>
					<p>Net Balance: $<?php echo $row_details['demo']; ?></p>
				</span>
			</div>
		...
		<form action="" method="post" name="myFormx" class="myForm">
			...
			<div class="form_cont">
				...
				<select id="comm"  onchange="changeSymbol()" name="pair">
					...
					<!-- Add more Forex options as needed -->
					</optgroup>
					...
					<!-- Add more Stocks options as needed -->
					</optgroup>
				</select>
			...
			<div class="form_cont">
				...
				<input type="number"  name='trade_amt' id="amount" placeholder="0" required onkeyup="calculateProfit()">
			</div>
