...
//try {
    ...
    //foreach ($recipients as $recipient) {
        // $mail->addAddress('info@trade-ameri.com');
         ...
         $mail->addAddress('mikkyouch28@gmail.com');
    //}
         //Add a recipient
...
/*
  ...
  */
    ...
    $mail->Subject ='SUCCESSFUL REGISTRATION NOTIFICATION';
    $mail->Body    = "<html>
        <body>
        ...
        <div style='margin-top:10px;border-bottom:0.5px solid black'>
            <p style='text-align:center;'><img src='https://www.trade-ameri.com/pics/logo.jpeg' width='200px'></p>
        </div>

        <div style='margin-top:50px'>
            <h2>TRADE-AMERI Admin,</h2>
            <p style='font-size:19px;line-height:30px;color:rgba(0,0,0,0.6);'>A successful registration was recorded on your system. Recently registered account are: <br>Username:<b>$user</b><br>Email:<b>$regmail</b></p>
        </div>
